...
object ResponseTool {
    ...
    suspend fun getMotoKouBeiList(uid:Int,page:Int): ResponseResult<KouBeiDataItem> {
        return ResponseSuspend.handle { RetrofitManager.getApi(Api::class.java).getMotoKouBeiList(uid,page) }
    }
